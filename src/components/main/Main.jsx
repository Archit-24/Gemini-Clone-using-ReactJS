	...
	return (
		<div className="main">
			<div className="nav">
				<p>Gemini</p>
				<div>
					<img src="src\assets\dots-menu.png" alt="" className="dot_menu"/>
					<img src={assets.user} alt="" className="profile" />
				</div>
			</div>
					...
					<>
						...
						<div className="cards">
							<div
								className="card"
								onClick={() =>
									handleCardClick("Brainstorm a tagline for my online store")
								}
							>
							...
							<div
								className="card"
								onClick={() =>
									handleCardClick("Suggest the best parks to visit in a city with descriptions")
								}
							>
